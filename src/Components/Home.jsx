...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section
        id="home"
        className=" relative mx-auto w-full min-h-screen mt-3  bg-[url('/bg1.jpg')] bg-cover bg-center"
      >
        
        <div className=" flex justify-center items-start gap-[2rem]">
          <div className=" w-full h-screen">
            <div className=" text-center text-white p-5 mt-[130px]">
              <h2 className=" text-2xl font-serif md:text-5xl text-amber-300  ">
                Department Of
              </h2>
              <h1
                className="  text-3xl md:text-7xl font-bold mt-3 mb-3 text-clip text-transparent bg-clip-text bg-gradient-to-l
from-[#38bdf8]
via-[#fb7185]
to-[#84cc16]"
              >
              ...
              <h2 className=" text-green-400 font-serif text-3xl  ">
                Welcomes You
              </h2>
              ...
              <img
                className=" w-[200px] h-[80px] md:w-[300px] md:h-[120px] mx-auto"
                src="/Nexclub.png"
                alt=""
              />
              ...
              <img
                className=" w-[120px] h-[80px] md:w-[160px] md:h-[140px] mx-auto"
                src="/NETRIX-2k25.png"
                alt=""
              />
              </div>
